...
if __name__ == '__main__':
	...
	for i in range(len(imgFiles[0][:])):
		feat1 = extract(imgFiles[0][i], args, model, device)
		feat2 = extract(imgFiles[1][i], args, model, device)

		im = drawMatches(imgFiles[0][i], imgFiles[1][i], feat1, feat2)
		cv2.imwrite('/scratch/udit/robotcar/overcast/ipm/d2net/' + str(i) + '.png', im)
		print(i)
